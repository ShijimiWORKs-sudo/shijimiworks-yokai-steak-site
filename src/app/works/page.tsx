...
export default async function WorksPage() {
  ...
  return <div className="content-page bg-[#f7f5ef]"><ContentHero eyebrow="Portfolio / Creative Archive" title="Works" copy="制作したもの、設計したもの、書いたもの、届けているもの。" description="ShijimiWORKsの制作実績と、妖怪ステーキの創作活動を横断してまとめています。" />
