...
const categories = ["All", "ShijimiWORKs", "App / MVP", "Web / Portfolio", "Automation", "Writing / Media", "Corporate AI", "妖怪ステーキ系", "Novel", "Cinema", "Podcast", "YouTube", "Rakugo"];

export default async function WorksPage() {
  const works = await getWorksFromNotion();
  return <div className="content-page archive-page works-archive bg-[#f7f5ef]"><ContentHero eyebrow="Portfolio / Creative Archive" title="Works" copy="制作したもの、設計したもの、書いたもの、届けているもの。" description="NETAKURA、DartsSupportApp、HPポートフォリオ001〜008、自動化、AI文書制作、妖怪ステーキの創作活動まで横断してまとめています。" />
