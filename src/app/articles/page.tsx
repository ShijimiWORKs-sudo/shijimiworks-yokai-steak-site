...
export default async function ArticlesPage() {
  ...
  return <div className="content-page bg-[#f7f5ef]"><ContentHero eyebrow="Journal / Magazine" title="Articles" copy="AI、創作、映画、落語、発信の記録。" description="ShijimiWORKsと妖怪ステーキの文章・記事・マガジン・感想をまとめています。" />
