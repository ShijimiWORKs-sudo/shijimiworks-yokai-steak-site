...
export default async function ArticleDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const continuationLinks = [{ label: "noteを見る", href: creative ? links.youkaiSteakNote : links.shijimiworksNote }, { label: "Substackを見る", href: links.shijimiworksSubstack }] as const;
